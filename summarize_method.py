...
def generateWeights(question):
    ...
    stop_words = [ "who", "what", "when","where", "why","how" ]
    word_frequencies = {}
...
if __name__ == "__main__":
    ...
    # curl -X POST http://0.0.0.0:8000/predict -H 'Content-Type: application/json' -d '{ "bank": "currently does not matter","question":"When can I close my account?" }'
